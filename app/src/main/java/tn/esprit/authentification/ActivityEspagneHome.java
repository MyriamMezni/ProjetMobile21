...
public class ActivityEspagneHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_espagne_home);
        ...
        nomtv=findViewById(R.id.nomtv4);
        ...
        hebergementFranceBT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(ActivityEspagneHome.this,ActivityHotelEspagne.class).putExtra("name",name));
        ...
        restaurantFranceBT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(ActivityEspagneHome.this,ActivityRestoEspagne.class).putExtra("name",name));
