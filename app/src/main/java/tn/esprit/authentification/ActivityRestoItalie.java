...
public class ActivityRestoItalie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resto_italie2);
        ...
        nomtv=findViewById(R.id.nomtv18);
        ...
        //setupHotels();
        restos=UserDatabase.getUserDatabase(this).restoDao().ReadAllItalie();
    ...
    {
        String name=getIntent().getStringExtra("name");
        Intent intent = new Intent(this, ActivityItalieHome.class).putExtra("name",name);
